...
public class IntListTest {
    ...
    public void testReverse() {
        ...
        IntList expected1 = IntList.list(3, 2, 1);
        test1 = IntList.reverse(test1);
        assertEquals(test1, expected1);

        IntList test2 = IntList.list(1, 2, 3);
        IntList expected2 = IntList.list(1, 2, 3);
        test2 = IntList.reverse(test2);
        assertNotEquals(test2, expected2);

        IntList test3 = IntList.list();
        IntList expected3 = IntList.list();
        test3 = IntList.reverse(test3);
